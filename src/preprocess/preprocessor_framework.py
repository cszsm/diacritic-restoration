...
from src.preprocess.lstm_sequence_tagging import process_for_train as process_for_lstm_sequence_tagging
...
class PreprocessorFramework:
    ...
    def create_parent_path(self, *args):
        parent_path = os.path.join(RESOURCE_DIRECTORY, 'prepared', self.preprocessor)
        for arg in args:
